...
function initializeVisualization() {
    ...
    // ** THE FIX: Calculate offset based on the button's position, not a fixed value **
    const header = document.getElementById('header');
    const headerBottom = header ? header.getBoundingClientRect().bottom + 20 : 150; // Add 20px padding
...
function setupEventListeners() {
    setupGuide(); // Initialize guide variables
